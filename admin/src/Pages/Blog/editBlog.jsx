    ...
    const context = useContext(MyContext);
      ...
      useEffect(()=>{
            ...
            fetchDataFromApi(`/api/blog/${id}`).then((res)=>{
                ...
                formFields.author = res?.blog?.author || ""
                formFields.category = res?.blog?.category || ""
                formFields.tags = Array.isArray(res?.blog?.tags) ? res?.blog?.tags.join(", ") : (res?.blog?.tags || "")
                formFields.isPublished = res?.blog?.isPublished !== undefined ? res?.blog?.isPublished : true
                ...
                <div className='scroll max-h-[72vh] overflow-y-scroll pr-4 pt-4'>
                    ...
                    <div className='grid grid-cols-1 mb-3'>
                        <div className='col w-[100%]'>
                            ...
                            <JoditEditor ref={editor} value={html} config={config} tabIndex={1} onBlur={newContent => onChangeDescription(newContent)} onChange={newContent => {}} />
