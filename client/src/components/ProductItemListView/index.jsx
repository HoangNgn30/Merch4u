...
import { deleteData, editData, postData, fetchDataFromApi, API_URL } from "../../utils/api";
...
const ProductItem = (props) => {
  ...
  return (
    <div className="productItem p-4 shadow-md bg-[#f1f1f1] rounded-md border border-[rgba(0,0,0,0.1)] flex items-center flex-col lg:flex-row relative">
      {
        isShowTabs === true &&
        <div className="absolute top-0 left-0 w-full h-full bg-[rgba(0,0,0,0.9)] z-[60] p-4 flex flex-col justify-center items-center gap-4 text-white rounded-md">
          ...
          {/* Add to Cart button */}
          <div className="w-full px-4 mt-2 max-w-[200px]">
            <Button
